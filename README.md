...
- **Backend**: FastAPI server on VPS (port 8080), exposed via Cloudflare Named Tunnel at `https://<your-domain>`
- **Frontend**: Single-file HTML SPA (`frontend.html`) deployed to Vercel at `<your-vercel-url>`
